...
> **Maintenance note:** This skill assumes the current 25-tool inventory and v21 GAQL field names. When the tool inventory or API version changes, update this playbook accordingly. (The keyword-research and asset tools added since — `get_keyword_ideas`, `create_sitelink_asset`, `create_callout_asset` — belong to the **klienta-ads** workflow, not this read-only audit.)
